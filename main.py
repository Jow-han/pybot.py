...
async def on_message(message):
        ...
        if words == "hello":
            ...
            voice = discord.utils.get(bot.voice_clients, guild=message.guild)
            voice.play(discord.FFmpegPCMAudio("gelocruz.mp3"))
            time.sleep(6)
        ...
        if "need" in words:
            ...
            await message.channel.send("https://images-ext-2.discordapp.net/external/rMF7uHkVpovUDZTQnHo4XAfudHHZHigLYJPa8ZW3Q98/https/i.pinimg.com/236x/c6/49/eb/c649eb07789ec9794983101fca8b01e7.jpg")
                ...
                await voice_channel.connect()
                voice = discord.utils.get(bot.voice_clients, guild=message.guild)
                voice.play(discord.FFmpegPCMAudio("happynewyear.mp3"))
                time.sleep(15)
                await voice.disconnect()
                return
        elif words == "bully":
            ...
            await voice_channel.connect()
            voice = discord.utils.get(bot.voice_clients, guild=message.guild)
            voice.play(discord.FFmpegPCMAudio("gonnacry.mp3"))
            time.sleep(4)
            await voice.disconnect()
            return
        elif words == "gameon":
            ...
            await voice_channel.connect()
            voice = discord.utils.get(bot.voice_clients, guild=message.guild)
            voice.play(discord.FFmpegPCMAudio("gaymoan.mp3"))
            time.sleep(7)
            await voice.disconnect()
            return
        elif words == "mataba":
            ...
            await voice_channel.connect()
            voice = discord.utils.get(bot.voice_clients, guild=message.guild)
            voice.play(discord.FFmpegPCMAudio("fatfuck.mp3"))
            time.sleep(7)
            await voice.disconnect()
            return
        elif words == "nigger":
            ...
            await voice_channel.connect()
            voice = discord.utils.get(bot.voice_clients, guild=message.guild)
            voice.play(discord.FFmpegPCMAudio("nigger.mp3"))
            time.sleep(7)
            await voice.disconnect()
            return
        elif words == "focus":
            ...
            await voice_channel.connect()
            voice = discord.utils.get(bot.voice_clients, guild=message.guild)
            voice.play(discord.FFmpegPCMAudio("dimakafocus.mp3"))
            time.sleep(4)
            await voice.disconnect()
            return
